...
export const Quotes = () => {
  ...
  return (
    <div className="flex mx-16 flex-col justify-center pb-10 ">
      <h1 className="text-6xl text-primary font-bold">Play Stake, Earn More!</h1>
      <h3 className="mt-4 text-md hover:leading-loose tracking-wide line-clamp-5 leading-8 mb-4">
      ...
      <Button onClick={() => router.replace("/game")} className="border-white border-2">
        Play Plinko
      </Button>
    </div>
  );
